async function postData(data) {
    await fetch('https://script.google.com/macros/s/AKfycbwmlMkyfvUShXJJO0qD0bZ_D_cbDCyfKWbKN9_F0cOCbs8-gd7aYIr_Wl3uyqJroVoTCA/exec', {
        method: 'POST',
        mode: 'no-cors',
        headers: {
...
function sendRequest(event) {
    postData({
        'date': `${(new Date()).toLocaleDateString('en-IE')} ${(new Date()).toLocaleTimeString('en-IE')}`,
        'email': document.getElementById('email').value,
        'bag': document.getElementById('text') != null ? document.getElementById('text').value : window.location.href
    })
